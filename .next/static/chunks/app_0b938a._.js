(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_0b938a._.js", {
...
axiosInstance.interceptors.request.use((config)=>{
    const keyApp = ("TURBOPACK compile-time value", "1aabac6d068eef6a7bad3fdf50a05cc8");
...
const findAll = async ({ name })=>{
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$axios$2e$wrapper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/applications${name ? `?name=${name}` : ""}`).catch((error)=>{
...
//# sourceMappingURL=app_0b938a._.js.map